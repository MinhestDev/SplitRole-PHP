...
<head>
  ...
  <link rel="shortcut icon" href="https://scapbot.com/wp-content/uploads/cropped-scapbot-favicon.png" type="image/x-icon"/>
  <title>Quản lý nhân sự | Scapbot</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php">
		<img src="https://scapbot.com/wp-content/uploads/logo-scapbot.svg" style="width: 50%" alt="">
	</a>
  </div>
  <!-- /.login-logo -->
